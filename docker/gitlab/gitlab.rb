...
#gitlab_rails['smtp_address'] = '{{ yunqi_apps_smtp_host }}'
#gitlab_rails['smtp_port'] = {{ yunqi_apps_smtp_port }}
#gitlab_rails['smtp_user_name'] = '{{ yunqi_apps_smtp_user }}'
#gitlab_rails['smtp_password'] = '{{ yunqi_apps_smtp_pass }}'
#gitlab_rails['smtp_domain'] = '{{ edom }}'
...
#gitlab_rails['gitlab_email_from'] = '"{{ yunqi_apps_smtp_from }}"'
#gitlab_rails['gitlab_email_display_name'] = '"[DD] Gitlab"'
#gitlab_rails['gitlab_email_reply_to'] = '"{{ yunqi_apps_smtp_reply_to }}"'
...
##! conjunction with propagate_correlation_id and
...
## Leave unassigned to use PostgreSQL's default values.
